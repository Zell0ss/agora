export const Ico = {
  ...
  users:    'M12.5 15v-1a2.5 2.5 0 00-2.5-2.5H5A2.5 2.5 0 002.5 14v1M7.5 8a2 2 0 100-4 2 2 0 000 4M17.5 15v-1a2.5 2.5 0 00-1.8-2.4M13 8.1a2 2 0 010 3.8',
  sparkle:  'M10 2l1.6 5.4L17 10l-5.4 1.6L10 18l-1.6-5.4L3 10l5.4-1.6L10 2z',
  check:    'M4 10.5l4 4 8-9',
  trash:    'M4 6h12M8 6V4h4v2M6.5 6l1 10h5l1-10',
